                        ...
                        <?php if (isset($reactivos) && is_array($reactivos) && count($reactivos) > 0): ?>
                            <?php foreach ($reactivos as $reactivo): ?>
                                <?php
                                    ...
                                    $nfpaDisplay = !empty($reactivo['normanfpa']) ? '/' . $reactivo['normanfpa'] : '';                                
                                ...
                                <img src="<?php echo htmlspecialchars($nfpaDisplay); ?>" alt="Imagen NFPA" class="w-16 h-16 object-contain border border-gray-300 rounded" />
                                <?php else: ?>
                                <p>No hay imagen NFPA</p>
                                <?php endif; ?>
                                </td>                                    
